//+------------------------------------------------------------------+
//|                                Madokasu_Spectrometr_Separate.mq4 |
//+------------------------------------------------------------------+
...
int start()
  {
   ...
   string ObjName=ObjNPref+"Zero line";
...
void fObjLabel(
               string aObjectName,     // 1 name
               int aX,                 // 2 x
               int aY,                 // 3 y
               string aText,           // 4 text
               int aCorner=0,          // 5 angle   0  1
               //          2  3
               color aColor=Black,// 6 Colour
               int aFontSize=8,        // 7 font size
               int aWindowNumber=0,    // 8 window
               string aFont="Arial Black",// 9 font
               bool aBack=false        // 10 background
               )
  {
...
void fObjTrendLine(
                   string aObjectName,  // 1 name
                   datetime aTime_1,    // 2 time 1
                   double aPrice_1,     // 3 price 1
                   datetime aTime_2,    // 4 time 2
                   double aPrice_2,     // 5 price 2
                   bool aRay=false,     // 6 Ray
                   color aColor=Black,// 7 Colour
                   int aWidth=1,        // 8 thickness
                   int aWindowNumber=0, // 9 window
                   int aStyle=1,        // 10 0-STYLE_SOLID, 1-STYLE_DASH, 2-STYLE_DOT, 3-STYLE_DASHDOT, 4-STYLE_DASHDOTDOT
                   bool aBack=false     // 11 background
                   )
  {
   if(ObjectFind(aObjectName)!=aWindowNumber)
     {
